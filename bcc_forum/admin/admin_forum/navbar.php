...
<nav class="navbar navbar-default alert-success " role="navigation">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <font size="5">
            <a href="home.php"><img src="../images/logoo.png" width="50" height="50" alt="..." class="img-square"/></a> Gold Fitness Forum 
         </font>
      ...
      <ul class="nav navbar-nav navbar-right">
      	...
      	<li><a href="home.php"><i class="fa fa-home"></i> Home</a></li>
        	<li><a href="#"><img src="../images/logoo.png" width="25" height="25" alt="..." class="img-square"/>  ( Admin )</a></li>
