    ...
    <center>
        ...
        <td>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div id="load_tweets2"><?php  include('sidebar.php'); ?></div>
                      ...
                      <?php  }
                        ...
                        if($ttttt=="NUTRITION"){ ?>
                            	<li ><a href="mac.php"><img src="../images/product.png" width="40" height="40" /> NUTRITION</a></li>
                       ...
                       if($ttttt=="PRODUCTS")
                        { ?>
                              <li ><a href="linux.php"><img src="../images/nutrition.png" width="40" height="40" />PRODUCTS</a></li>
                ...
                <td>&nbsp;</td>
                <td>
                <?php if($ttttt=="FITNESS"){ ?><a href="home.php" class="btn btn-default pull-right">Back</a> <?php } ?>
                 <?php if($ttttt=="NUTRITION"){ ?><a href="mac.php" class="btn btn-default pull-right">Back</a> <?php } ?>
                  <?php if($ttttt=="PRODUCTS"){ ?><a href="linux.php" class="btn btn-default pull-right">Back</a> <?php } ?>
